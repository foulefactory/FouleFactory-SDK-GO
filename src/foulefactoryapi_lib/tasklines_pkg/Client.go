 ...
 */
type TASKLINES_IMPL struct { }

/**
 * Create new task line
 * @param    *models_pkg.TaskLinesWriterServiceModel        taskLines           parameter: Required
 * @param    *string                                        acceptLanguage      parameter: Optional
 * @return	Returns the interface{} response from the API call
 */
func (me *TASKLINES_IMPL) CreateTaskLinesCreateTaskLine (
            taskLines *models_pkg.TaskLinesWriterServiceModel,
   ...
   _queryBuilder = _queryBuilder + "/v1.1/taskLines"
    ...
    //prepare API request
    _request := unirest.PostWithAuth(_queryBuilder, headers, taskLines, foulefactoryapi_lib.Config.BasicAuthUserName, foulefactoryapi_lib.Config.BasicAuthPassword)
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *TASKLINES_IMPL) GetTaskLinesGetTasksByLine (
            id int64,
            acceptLanguage *string) (interface{}, error) {
        //the base uri for api requests
    _queryBuilder := foulefactoryapi_lib.BASEURI;
 ...
 * @return	Returns the interface{} response from the API call
 */
func (me *TASKLINES_IMPL) GetTaskLinesGet (
            id int64,
            acceptLanguage *string) (interface{}, error) {
        //the base uri for api requests
    _queryBuilder := foulefactoryapi_lib.BASEURI;
